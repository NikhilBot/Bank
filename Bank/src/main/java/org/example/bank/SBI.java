...
public class SBI extends Bank {
    ...
    private static String IFSC = "SBIN0000123";
    ...
    @Override
    public void createAccount ( String accountNo , long money ) {
    ...
    public void transferMoney ( String toAccountNo , String fromAccountNo , long money ) {
        ...
        long totalMoneyToAccount = userAccounts.getOrDefault(toAccountNo , -1L);
        long totalMoneyFromAccount = userAccounts.getOrDefault(fromAccountNo , 0L);
        if (totalMoneyFromAccount - money <= 500) {
